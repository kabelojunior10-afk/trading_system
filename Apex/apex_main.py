...
{Fore.YELLOW}Expected drawdown: 70-85%. Only use risk capital!{Style.RESET_ALL}
...
def print_apex_config_summary(config) -> None:
    ...
    print(f"  • Annual return target : 400-800%")
    print(f"  • Expected drawdown    : 70-85%")
    print(f"  • Win rate             : 30-35% (high risk/reward)")
    print(f"  • Avg trade duration   : Minutes to hours")
    print(f"  • Monthly trades       : 100-200")
