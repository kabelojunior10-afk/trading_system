...
class SymbolState:
    ...
    def can_close_position(self) -> bool:
        cooldown = min(TIMEFRAME_META[self.config.primary_tf]["cooldown"], 30)
    ...
    # CORRECTED: NO forecast fade exit - only exit via trailing stop
    ...
    # Stop and Reverse - valid closing method per the text
