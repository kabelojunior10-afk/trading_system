...
class OrderManager:
    ...
    def place_order(
        ...
        take_profit:   Optional[float] = None,  # Keep parameter but we won't use it
        ...
        for stop_attempt in range(2):
            ...
            # if take_profit:
            #     request["tp"] = take_profit  # COMMENTED OUT - no take profit
