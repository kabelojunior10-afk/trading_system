...
class MultiSpeedEWMAC:
    ...
    Both components are capped at ±20.
    """
    ...
    def __init__(
        ...
        # Breakout speeds - with multiplier to match EWMAC range (±20)
        self.breakout_speeds = get_default_breakout_speeds(timeframe)
        
        # Use a multiplier of 20.0 to match EWMAC's range
        breakout_multiplier = getattr(cfg, 'breakout_multiplier', 20.0)
        
        self.breakout_strategy = MultiSpeedBreakout(
            speeds=self.breakout_speeds,
            forecast_cap=cfg.cap_max,  # Now ±20
        ...
        logger.info(
            ...
            f"Breakout multiplier={breakout_multiplier} | Forecast cap=±{cfg.cap_max}"
        )
