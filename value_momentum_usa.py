...
# ============================================================
# US STOCK TICKERS (Complete ThinkMarkets CFD List)
# ============================================================

tickers = [
    # A
    "AAP", "ABT", "ABBV", "ACN", "ADI", "ADBE", "ADP", "AFL", "A", "AGNC", 
    "AEM", "AIV", "ABNB", "APD", "AJG", "AKAM", "ALK", "ALB", "BABA", 
    "ALLE", "BFH", "ALSN", "ALL", "ALNY", "GOOGL", "MO", 
    
    # AM - AZ
    "AMZN", "DOX", "AEE", "AAL", "AEP", "AXP", "AWK", "AMP", "AMG", "APH", 
    "NLY", "ELV", "AON", "AOS", "APTV", "ANET", "ASH", "AGO", "ASR", 
    "ADSK", "AN", "AVY", "AVT", "BIDU", "CIB", "BHC", 
    
    # B
    "BAX", "BCE", "BDX", "BEN", "BRK.B", "BBY", "BILI", "BLK", "BX", "BK", 
    "BA", "BAH", "SAM", "BFAM", "BHF", "BR", "BUD", "BVN", "CABO", "CDNS", 
    "COF", "CAH", "CCL", "CRI", "CASY", "CCU", 
    
    # C
    "CDW", "CE", "CVE", "CF", "GIB", "CHKP", "CHE", "CVX", "CHRW", "CB", 
    "CHDN", "CIEN", "CI", "CINF", "CTAS", "C", "CFG", "CME", "CMS", "CNA", 
    "CNI", "CCEP", "CTSH", "COIN", "CL", "COLM", 
    
    # CO - CZ
    "CMCSA", "CAG", "COP", "STZ", "COO", "CP", "CSX", "CMI", "CW", "CVI", 
    "DHR", "DVA", "DECK", "DE", "DAL", "DXCM", "FANG", "DIS", "DLB", "DG", 
    "DLTR", "DCI", "DEI", "DOV", "DHI", "RDY", 
    
    # D
    "DTE", "DXC", "EMN", "EIX", "ESLT", "EA", "EME", "EMR", "ENTG", "ETR", 
    "EOG", "EPAM", "EFX", "ESNT", "ES", "EXEL", "EXPE", "EXR", "FCX", "FDX", 
    "FAF", "FCFS", "FSLR", "FLO", "FLS", "FMC", 
    
    # F
    "FNV", "F", "FTS", "FTV", "GRMN", "IT", "GE", "GNRC", "GD", "GIS", "G", 
    "GNTX", "GPC", "GILD", "GM", "GGG", "LOPE", "GPK", "TV", "GWRE", "HAE", 
    "HIG", "HCA", "HQY", "PEAK", "HP", 
    
    # H
    "HSIC", "HSY", "HXL", "HIW", "HLT", "HD", "HMC", "HON", "HPQ", "HRB", 
    "HUBB", "HPP", "HUM", "HUYA", "IBM", "ICE", "IDXX", "NGVT", "INGR", 
    "NSP", "IART", "IAC", "IONS", "IRM", "J", "JBGS", 
    
    # J - K
    "JCI", "JD", "JEF", "JNJ", "JPM", "KB", "KRC", "KIM", "KMI", "KGC", 
    "KEX", "KSS", "LH", "LW", "LDOS", "LEN", "LII", "LFUS", "LKQ", "LLY", 
    "LMT", "L", "LOGI", "LOW", "MAA", "MAC", 
    
    # M
    "MGA", "MAN", "MKTX", "MAR", "MLM", "MRVL", "MKC", "MCD", "MCK", "MDU", 
    "MLCO", "MELI", "MRCY", "META", "MET", "MGM", "MCHP", "MU", "MSFT", 
    "MMM", "MHK", "TAP", "MOMO", "MDLZ", "MNST", "MCO", 
    
    # MO - MZ
    "MSI", "MUFG", "MUR", "NDAQ", "NFG", "NTAP", "NFLX", "NWL", "NEU", "NWS", 
    "NKE", "NIO", "NI", "NJR", "NOC", "NOV", "NVDA", "NXPI", "OXY", "ODFL", 
    "OLED", "OGS", "ON", "OTEX", "OSK", "OVV", 
    
    # P
    "PCAR", "PAGS", "PAYX", "PAYC", "PYPL", "PSFE", "PAG", "PEP", "PRGO", 
    "PFE", "PM", "PDD", "PNC", "PNM", "PII", "POOL", "PKX", "PPG", "PPL", 
    "PGR", "PLD", "PSEC", "PRU", "PEG", "PTC", "PSA", 
    
    # P - Q
    "PHM", "QRVO", "QSR", "QCOM", "DGX", "RL", "RCL", "REG", "RNR", "RMD", 
    "RF", "RNG", "RBA", "RHI", "ROP", "RSG", "RYAAY", "SRPT", "SBAC", "ST", 
    "SHG", "SLAB", "SNN", "SNAP", "SNA", "SCCO", 
    
    # S
    "LUV", "SWX", "SQM", "SBUX", "STT", "STE", "SYK", "SU", "SLF", "SYF", 
    "SNX", "SYY", "TSM", "TAL", "TGT", "TDOC", "TDY", "TLK", "TU", "TSLA", 
    "TEVA", "TRI", "TJX", "TTC", "TM", "TSCO", 
    
    # T - U
    "TDG", "TRV", "TRIP", "TCOM", "TROW", "TXN", "TYL", "TSN", "UBER", "UDR", 
    "UGI", "ULTA", "UAA", "UNH", "VLO", "VRSN", "VRSK", "VFC", "VIPS", "V", 
    "VOYA", "WAB", "WCN", "WAT", "WBS", "WB", 
    
    # W
    "WFC", "WELL", "WEN", "WDC", "WST", "WY", "WMB", "WTW", "WM", "XRAY", 
    "XYL", "YUMC", "ZTO", 
    
    # Additional recent listings
    "GME", "VFS", "ARM", "KVUE", "CART", "FTAI", "IBKR", "PERMIANRES", 
    "REMITLY", "SEADRILL", "TRADEWEB", "PARSONS", "RDDT", 
    
    # I - L (new additions)
    "IFF", "IGSB", "IHI", "IJJ", "ILMN", "IMO", "INCY", "INFY", "IR", "INTC",
    "INTU", "INVES", "IPGP", "IQV", "ISRG", "ITT", "ITW", "IVV", "IWB",
    "IWD", "IWO", "IWR", "IYW", "JBL", "JKHY", "JAZZ", "JBHT", "JBLU",
    "JLL", "ZD", "JMIA", "KDP", "KEY", "KEYS", "KKR", "KLAC", "KHC",
    "KR", "LAMR", "LRCX", "LSTR", "LAZ", "LBTYA", "LBTYK", "LEA", "LEG",
    "LECO", "LYV", "LNC", "LQD", "LULU", "LVS", "LYFT", "LYB", "M",
    
    # M continued
    "M", "MANH", "MFC", "MPC", "MKL", "VAC", "MAS", "MTZ", "MA", "MAT",
    "MMS", "MSM", "MDT", "MRK", "MTD", "MTG", "MIDD", "MKSI", "MRNA",
    "MOH", "MDB", "MPWR", "MS", "MORN", "MOS", "MPLX", "MSA", "MSCI",
    "MTUM", "NGG", "NNN", "NTES", "NBIX", "NEM", "NYT", "NEE", "NICE",
    
    # N - O
    "NDSN", "NSC", "NCLH", "NVO", "NRG", "NUE", "OGE", "OKTA", "OHI",
    "OMC", "OKE", "ORCL", "ORLY", "IX", "OC", "PLTR", "PANW", "PH",
    "PNR", "PG", "PCG", "PPC", "PNW", "PIPR", "PAA", "PLDT", "PLUG",
    "POR", "POST", "PFG", "PVH", "PWR", "RDN", "RJF", "RTX", "RY",
    "O", "RRGB", "REGN", "RGA", "RS", "RGEN", "REXR", "RIVN", "HOOD",
    "RBLX", "ROK", "ROKU", "ROL", "ROST", "RGLD", "RPM", "SAIC",
    
    # S - T
    "CRM", "SLM", "SNY", "SLB", "SCHW", "SMG", "SDY", "SE", "STX",
    "SIGI", "SRE", "SCI", "NOW", "SHW", "SHOP", "SVXY", "SBGI",
    "SIRI", "SKM", "SWKS", "SLG", "SJM", "SON", "SONY", "SO", "SPXL",
    "SPGI", "SPOT", "SSNC", "SWK", "STWD", "STLD", "STRA", "SUI",
    "SNPS", "TTWO", "TPR", "TRGP", "TD", "TECK", "TEL", "TFX", "TS",
    "TDC", "TER", "TTEK", "TXT", "TMO", "TLRY", "TMUS", "TOL",
    "TRMB", "TNET", "TWLO", "TXRH", "UNP", "UAL", "URI", "UHS",
    "UNM", "UPS", "USB", "MTN", "VCIT", "VEEV", "VTR", "VZ",
    
    # V - Z
    "VRTX", "VGT", "VSAT", "VTRS", "VNO", "VPU", "VTV", "VUG",
    "VMC", "WMT", "WSO", "W", "WEC", "WU", "WLK", "WEX",
    "WPM", "WHR", "WSM", "WWD", "WDAY", "WPC", "WYNN", "XBI",
    "XEL", "XLB", "XLE", "XLK", "XLV", "XLY", "XPEV", "YPF",
    "YUM", "ZBRA", "Z", "ZBH", "ZION", "ZOETIS", "ZM", "ZS",
    
    # Additional stocks from final images
    "BEAM", "BMRN", "BSX", "GOOS", "CHWY", "DDOG", "FNKO", "NTLA",
    "NVAX", "PKG", "PTON", "PENN", "PINS", "RIOT", "SPG", "FTI",
    "SPCE", "XLP", "ARKK", "IAU", "IEFA", "USO", "VCSH"
]

# Remove duplicates
tickers = list(dict.fromkeys(tickers))

print(f"Total US tickers to analyze: {len(tickers)}")
...
print(f"\nSuccessfully processed {len(df)} stocks")
if failed_tickers:
    print(f"Failed to process {len(failed_tickers)} tickers")
...
filename = f"US_Stock_Rankings_{timestamp}.csv"
...
filename_excel = f"US_Stock_Rankings_{timestamp}_formatted.csv"
...
print("US STOCK RANKINGS (ThinkMarkets CFDs)")
print("="*80)
