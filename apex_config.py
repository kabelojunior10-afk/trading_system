...
class StrategyConfig:
    ...
    breakout_multiplier: float = 20.0  # Changed from 50.0 to 20.0

    vol_lookback: int = 20
    cap_min: float = -20.0  # Changed from -50.0
    cap_max: float = +20.0  # Changed from +50.0
    fdm: float = 2.0
...
APEX_SYMBOLS: Dict[str, SymbolConfig] = {
    ...
    "TRUMPUSD": SymbolConfig(
        symbol="TRUMPUSD", enabled=False, primary_tf=TimeFrame.H1,
        trading_days=365, min_volume=1.0, max_volume=50.0, volume_step=0.01,
        vol_target_pct=0.0100, max_daily_trades=8
    ),
    "HYPEUSD": SymbolConfig(
        symbol="HYPEUSD", enabled=False, primary_tf=TimeFrame.H1,
        trading_days=365, min_volume=0.1, max_volume=5.0, volume_step=0.01,
        vol_target_pct=0.0100, max_daily_trades=8
    ),
    "ICPUSD": SymbolConfig(
        symbol="ICPUSD", enabled=False, primary_tf=TimeFrame.H1,
        trading_days=365, min_volume=0.1, max_volume=5.0, volume_step=0.01,
        vol_target_pct=0.0100, max_daily_trades=8
    ),
    "MUSD": SymbolConfig(
        symbol="MUSD", enabled=False, primary_tf=TimeFrame.H1,
        trading_days=365, min_volume=0.1, max_volume=5.0, volume_step=0.01,
        vol_target_pct=0.0100, max_daily_trades=8
    ),
    "TAOUSD": SymbolConfig(
        symbol="TAOUSD", enabled=False, primary_tf=TimeFrame.H1,
        trading_days=365, min_volume=0.1, max_volume=50.0, volume_step=0.01,
        vol_target_pct=0.0100, max_daily_trades=8
    ),
    "TONUSD": SymbolConfig(
        symbol="TONUSD", enabled=False, primary_tf=TimeFrame.H1,
        trading_days=365, min_volume=0.1, max_volume=5.0, volume_step=0.01,
        vol_target_pct=0.0100, max_daily_trades=8
    ),
    "TRXUSD": SymbolConfig(
        symbol="TRXUSD", enabled=False, primary_tf=TimeFrame.H1,
        trading_days=365, min_volume=0.1, max_volume=50.0, volume_step=0.01,
        vol_target_pct=0.0100, max_daily_trades=8
    ),
    "WLFIUSD": SymbolConfig(
        symbol="WLFIUSD", enabled=False, primary_tf=TimeFrame.H1,
        trading_days=365, min_volume=0.1, max_volume=50.0, volume_step=0.01,
        vol_target_pct=0.0100, max_daily_trades=8
    ),
    "XMRUSD": SymbolConfig(
        symbol="XMRUSD", enabled=False, primary_tf=TimeFrame.H1,
        trading_days=365, min_volume=1.0, max_volume=5.0, volume_step=0.01,
        vol_target_pct=0.0100, max_daily_trades=8
    ),
    "ZECUSD": SymbolConfig(
        symbol="ZECUSD", enabled=False, primary_tf=TimeFrame.H1,
        trading_days=365, min_volume=1.0, max_volume=5.0, volume_step=0.01,
        vol_target_pct=0.0100, max_daily_trades=8
    ),
}
...
def load_apex_config() -> SystemConfig:
    ...
    strategy_config.breakout_multiplier = 20.0
    strategy_config.cap_min = -20.0
    strategy_config.cap_max = +20.0
