...
TIMEFRAME_META = {
    ...
    TimeFrame.M5: {
        ...
        "atr_multiplier": 288,
        "stop_multiplier": 1.2,
        "description": "5 Min - Ultra aggressive",
    },
}
...
class SymbolConfig:
    symbol: str
    enabled: bool = True
    primary_tf: str = TimeFrame.M5
    max_positions: int = 1
    max_daily_trades: Optional[int] = 15
...
APEX_SYMBOLS: Dict[str, SymbolConfig] = {
    "BTCUSD": SymbolConfig(
        symbol="BTCUSD", enabled=True, primary_tf=TimeFrame.M5,
        trading_days=365, min_volume=0.01, max_volume=5.0, volume_step=0.01,
        vol_target_pct=0.0080, max_daily_trades=15
    ),
    "ETHUSD": SymbolConfig(
        symbol="ETHUSD", enabled=True, primary_tf=TimeFrame.M5,
